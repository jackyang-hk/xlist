...
kg/xlist/3.0.2/dataset
kg/xlist/3.0.2/index

*/
;KISSY.add('kg/xlist/3.0.2/dataset',function(S){
...
;
KISSY.add('kg/xlist/3.0.2/index',function(S, Node, Event, XScroll, Util,DataSet) {
	var $ = S.all;
	//transform
	...
	requires: ['node', 'event', 'kg/xscroll/1.1.6/index', 'kg/xscroll/1.1.6/util','./dataset']
})
